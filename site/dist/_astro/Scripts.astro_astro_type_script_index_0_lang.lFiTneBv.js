...
</html>`}function V(e,t){const n=$(e);n.action=y("/run",t),n.target=w(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function h(e){return e?.contentWindow?(F(e)??new q(e)).pending:Promise.reject("Provided element is not an iframe.")}function z(e,t){V(e,t)}function K(e,t){const n=y(`/edit/${e}`,t),o=w(t);window.open(n,o)}function G(e,t){const n=y(`/github/${e}`,t),o=w(t);window.open(n,o)}function W(e,t,n){const o=v(e),r=H(t,n),s=document.createElement("iframe");return E(o,s,n),s.contentDocument?.write(r),h(s)}function J(e,t,n){const o=v(e),r=document.createElement("iframe");return r.src=b(`/edit/${t}`,n),E(o,r,n),h(r)}function X(e,t,n){const o=v(e),r=document.createElement("iframe");return r.src=b(`/github/${t}`,n),E(o,r,n),h(r)}const Y={connect:h,embedGithubProject:X,embedProject:W,embedProjectId:J,openGithubProject:G,openProject:z,openProjectId:K},Q=`// NOTICE!!! Initially embedded in our docs this JavaScript
...
`,g={cssCdn:"https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css",jsBundleCdn:"https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js",docsVersion:"5.3"};document.querySelectorAll(".btn-edit").forEach(e=>{e.addEventListener("click",t=>{const n=t.target.closest(".bd-code-snippet"),o=n.querySelector(".bd-example"),r=o.innerHTML,s=n.querySelector(".btn-edit").getAttribute("data-sb-js-snippet"),i=Array.from(o.classList).join(" ");Z(r,s,i)})});const Z=(e,t,n)=>{const r={files:{"index.html":`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
</html>`,...t&&{"index.js":Q}},title:"Bootstrap Example",description:`Official example from ${window.location.href}`,template:t?"javascript":"html",tags:["bootstrap"]};Y.openProject(r,{openFile:"index.html"})};
